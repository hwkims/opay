...
$("header li").mouseover(function(){
    ...
    $(this).find(".item").css("color","#f63d5b");
});
...
$(window).scroll(function(){
        var here = $(".con1").offset().top;
        if(here < $(document).scrollTop()){
            $(".con1 .con7_mid_top").css('position','fixed')
            $(".con1 .con7_mid_top").css('top','0')
            $(".con1 .con7_mid_top").css('z-index','1001')
        }else{
            $(".con1 .con7_mid_top").css('position','relative')
            $(".con1 .con7_mid_top").css('top','unset')
            $(".con1 .con7_mid_top").css('z-index','1001')
        }
})
    ...
    if(mobileCheck()){
        for(var i=0;i<$('#hd_pop > div').get().length;i++){
            ...
            if($('#hd_pop > div:nth-of-type('+(i+1)+') > div:has(iframe)').length < 1){
                $('#hd_pop > div > div > p').get()[i].innerHTML =$('#hd_pop > div > div > p').get()[i].innerHTML.replace(/&nbsp/g, '');
            }else{
